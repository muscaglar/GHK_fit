function [] = extreme_GHK_Output_Origin(input,plotName,sheetName,folderDirectory)
...
ORG.ExecuteLabTalk('wks.col2.lname$ = Voltage Offset Error;');
ORG.ExecuteLabTalk('wks.col2.type = 3;');

ORG.ExecuteLabTalk('wks.col3.lname$ = Concetration Ratio;');
ORG.ExecuteLabTalk('wks.col3.type = 4;');

ORG.ExecuteLabTalk('wks.col4.lname$ = Model Response;');
